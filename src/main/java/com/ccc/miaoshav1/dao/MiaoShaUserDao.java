...
public interface MiaoShaUserDao {
    ...
    @Update("update miaosha_user set last_login_date = #{lastLoginDate}, login_count = login_count + 1 where id = #{id}")
    public void updateLoginInfo(MiaoshaUser toBeUpdate);
